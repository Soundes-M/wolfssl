...
int main(int argc, char **argv) {
    ...
    size_t buffer_size = fread(&buffer, 1, XMSS_OID_LEN, keypair_file);
    ...
    buffer_size = fread(&buffer, 1, XMSS_OID_LEN, keypair_file);
    ...
    buffer_size = fread(sk, 1, XMSS_OID_LEN + params.sk_bytes, keypair_file);
    buffer_size = fread(m, 1, mlen, m_file);
